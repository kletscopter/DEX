//heeft 2 belangrijke functies
//addLiquidity en calculateCD
//voor addLiquidity ga je eerst moeten approven,
//omdat dit een ERC20 token is en als het contract een ER20 token withdrawed van een user moet er eerst approval komen
...
export const addLiquidity = async (
  ...
  try {
    ...
    ); //user moet allowance geven aan het exchange Contract
    await tx.wait();
    //als dat gelukt is -> liquidity toevoegen
